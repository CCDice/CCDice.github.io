...
var config = {
  ...
  recaptcha_sitekey: '6LeefwwTAAAAAAgllXTXnSqW7emQqq3ffUsSYgJn',  // <----- EDIT ME!
  redirect_uri: 'https://ccdice.net',
        ...
        el.div(
          ...
          el.div(
            ...
            el.button(
              ...
              'Bet High ', worldStore.state.hotkeysEnabled ? el.kbd(null, 'H') : ''
            )
          ),
          // bet lo
          el.div(
            ...
            el.button(
              ...
              'Bet Low ', worldStore.state.hotkeysEnabled ? el.kbd(null, 'L') : ''
            )
          )
        );
    } else {
